...
/**
 * TraceableMessageCommand is based on Yii MessageCommand.
 * As an addition, it includes the source file path in the message files
 * so you can easily track back to the file when you would like to modify
 * the message text.
 * 
 * @author yaowenh@sumilux.com
 */
...
*
* This file is automatically generated by 'yiic traceablemessage' command.
